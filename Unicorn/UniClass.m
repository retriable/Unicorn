...
- (BOOL)openAndInit:(NSString*)file error:(NSError**)error{
    ...
    if ([self.cls respondsToSelector:@selector(uni_automaticallyUpdatedPropertynames)])  self.automaticallyUpdatedPropertynames=[self.cls uni_automaticallyUpdatedPropertynames];
